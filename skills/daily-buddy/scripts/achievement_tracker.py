...
# ─── 路径配置 ────────────────────────────────────────────────
DIARY_DIR = Path(os.path.expanduser("~/[日记仓库]/[日记子目录]"))
ACHIEVEMENT_DIR = Path("[记忆共享中心]/成就系统")
DATA_FILE = ACHIEVEMENT_DIR / "scripts" / "achievement_data.json"
READING_NOTES_DIR = Path(os.path.expanduser("~/[日记仓库]/2-知识库/01-读书笔记"))
GREATEST_ME_DIR = Path("[记忆共享中心]/最伟大的我/成就证据")  # 与最伟大的我联动
...
def sync_memory_md():
    ...
    memory_files = [
        ...
        Path.home() / "[记忆共享中心]" / "QClaw记忆" / "MEMORY.md",
    ]
