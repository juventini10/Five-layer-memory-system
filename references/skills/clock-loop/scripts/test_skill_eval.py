...
class TestRealSkills(unittest.TestCase):
    ...
    def test_triwich_score(self):
        ...
        result = os.popen(
            f'python3 ~/个人AI档案/技能配置/clock-loop/scripts/skill_eval.py --check-only {skill_dir}/ 2>&1'
        ).read()
        d = json.loads(result)
...
class TestAdversarialSamples(unittest.TestCase):
    ...
    def test_gs1_perfect_score(self):
        ...
        result = os.popen(
            f'python3 ~/个人AI档案/技能配置/clock-loop/scripts/skill_eval.py {path} 2>&1'
        ).read()
    ...
    def test_gs2_attack_score_below_gs1(self):
        ...
        r1 = os.popen(
            f'python3 ~/个人AI档案/技能配置/clock-loop/scripts/skill_eval.py {gs1_path} 2>&1'
        ).read()
        r2 = os.popen(
            f'python3 ~/个人AI档案/技能配置/clock-loop/scripts/skill_eval.py {gs2_path} 2>&1'
        ).read()
